...
``structure``
    A ``GroupBuilder`` that defines how to filter, group, transform, and sub-divide the selected results.
...
The ``GroupBuilder`` is the core abstraction of postprocessing.
