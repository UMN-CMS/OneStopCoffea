...
\begin{tikzpicture}
  \node[regular polygon, regular polygon sides=8, minimum size=5cm, 
  draw=white, fill=BrickRed, line width=2pt, inner sep=0.1cm] (stop) {};
  
  \node[regular polygon, regular polygon sides=8, minimum size=4.4cm, 
  draw=white, line width=2pt] (stop-border) {};
  
  % From https://texample.net/coffee-cup/
  \def\c{white}
  \colorlet{cup}{\c}
  ...
  \begin{scope}
    ...
    (0,-1/4) ellipse [x radius=3/4, y radius=3/8];
    \node at (0.02,-0.15cm) {\includegraphics[width=1.66cm]{coffea_perspective}};
  \end{scope}
